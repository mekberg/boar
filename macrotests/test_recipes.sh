...
python3 "${BOARTESTHOME}/mkrandfile.py" 0 1000000 A || exit 1
python3 "${BOARTESTHOME}/mkrandfile.py" 1 1000000 B || exit 1
python3 "${BOARTESTHOME}/mkrandfile.py" 2 1000000 C || exit 1
